...
## A1 
Here are 'rules' to verify if an ifc-model for no. of claimed desks and bicycle stands
...
## A2
The chosen use case is to verify whether the desk space in each room is compliant, using the Building2516 (ARCH-25-16-D) for our analysis.
...
## A3
Code to verify whether the desk space in each room is compliant as shown in A2, using the Building2516 (ARCH-25-16-D). 
